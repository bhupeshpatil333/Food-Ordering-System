<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="Chhotu.User.Registration" %>
                    ...
                    <div class="form_container">
                        ...
                        <div>
                            ...
                            <asp:RegularExpressionValidator ID="revName" runat="server"
                               ...
                               ForColor="Red" Display="Dynamic" SetFocusOnError="true" ValidationExpression="^[a-zA-Z\s]+$"
                        ...
                        <div>
                            ...
                            <asp:RegularExpressionValidator ID="revMobile" runat="server"
                               ...
                               ForColor="Red" Display="Dynamic" SetFocusOnError="true" ValidationExpression="^[0-9]{10}$"
                    ...
                    <div class="form_container">
                        ...
                        <div>
                            ...
                            <asp:RegularExpressionValidator ID="revPostCode" runat="server"
                               ...
                               ForColor="Red" Display="Dynamic" SetFocusOnError="true" ValidationExpression="^[0-9]{6}$"
                ...
                <div class="row pl-4">
                    <div class="btn_box">
                        ...
                        <asp:Label ID="lblAlreadyUser" runat="server" CssClass="pl-3 text-black-100"
                            Text="Already registred? <a href='Login.aspx' class='badge badge-info'>Login here..</a>"></asp:Label>
                    </div>
                </div>
